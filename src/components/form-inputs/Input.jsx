  ...
  return (
    <div className="flex min-w-0 flex-col gap-1 p-0 relative">
      ...
      <input
        ...
        className={`border ${!error ? "border-gray-50 text-gray-600" : 'border-red-400 text-red-500'} bg-gray-100 px-3 py-1.5 rounded text-sm focus:outline-none focus:ring-2 focus:ring-purple-100 disabled:cursor-not-allowed disabled:opacity-70 read-only:cursor-not-allowed ${className}`}
        disabled={isDisabled}
        readOnly={isReadOnly}
        {...rest}
      />
