...
export function getPatientIdentifier(user = {}) {
  return user?.patient_id;
}
// export function normalizePatientData(selectedUser = {}) {
//   return {
//     ...patientsModuleSchema.form.initialValues,
//     ...selectedUser,
...
//   };
// }
export function normalizePatientData(selectedPatient = {}) {
  return {
    ...patientsModuleSchema.form.initialValues,
    ...selectedPatient,
    // clinic_id: selectedPatient?.clinic_id || selectedPatient?.clinicId || "",
    first_name: selectedPatient?.first_name || selectedPatient?.firstName || "",
    middle_name: selectedPatient?.middle_name || selectedPatient?.middleName || "",
    last_name: selectedPatient?.last_name || selectedPatient?.lastName || "",
    full_name: selectedPatient?.full_name || selectedPatient?.fullName || "",
    mobile_no: selectedPatient?.mobile_no || selectedPatient?.mobileNo || selectedPatient?.contactNo || "",
    email: selectedPatient?.email || "",
    date_of_birth: selectedPatient?.date_of_birth ? new Date(selectedPatient.date_of_birth).toISOString().split("T")[0] : "",
    age: selectedPatient?.age !== null && selectedPatient?.age !== undefined ? selectedPatient.age : "",
    age_unit: selectedPatient?.age_unit || selectedPatient?.ageUnit || "",
    gender: selectedPatient?.gender || "",
    blood_group: selectedPatient?.blood_group || selectedPatient?.bloodGroup || "",
